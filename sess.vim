...
nnoremap br :Dispatch! make -C build/Release
nnoremap bd :Dispatch! make -C build/Debug
nnoremap m :Copen | G" Build debug and release targets
map  :NERDTreeToggle
...
map <F9> :w:!ruby -c %
nnoremap <C-M>br :Dispatch! make -C build/Release
nnoremap <C-M>bd :Dispatch! make -C build/Debug
nnoremap <C-M>m :Copen | G" Build debug and release targets
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set background=dark
...
silent only
silent tabonly
cd /run/media/scion/96242da8-b37a-4597-9b64-93d7374c1a9f/repos/shScr
...
exe 'vert 2resize ' . ((&columns * 64 + 48) / 96)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 81 - ((80 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 81
